...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateTournamentRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.FinishMiniGameRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.MiniGameLeaderboardEntry"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handlers.StartMiniGameResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.ClaimRewardRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UserDelete"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.CreateTournamentRequest": {
            "type": "object",
            "properties": {
                "endedAt": {
                    "type": "string"
        ...
        "handlers.FinishMiniGameRequest": {
            "type": "object",
            "properties": {
                "hash": {
                    "type": "string"
        ...
        "handlers.MiniGameLeaderboardEntry": {
            "type": "object",
            "properties": {
                "score": {
                    "type": "integer"
        ...
        "handlers.StartMiniGameResponse": {
            "type": "object",
            "properties": {
                "duration": {
                    "type": "integer"
